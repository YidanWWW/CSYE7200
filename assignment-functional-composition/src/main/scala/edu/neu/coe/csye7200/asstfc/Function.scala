...
object Function {
  ...
  // TO BE IMPLEMENTED 
    (t1y: Try[T1], t2y: Try[T2]) => map2(t1y, t2y)(f)
  ...
  // TO BE IMPLEMENTED 
    (t1y: Try[T1], t2y: Try[T2], t3y: Try[T3]) => map3(t1y, t2y, t3y)(f)
  ...
  // TO BE IMPLEMENTED 
    (t1y: Try[T1], t2y: Try[T2], t3y: Try[T3], t4y: Try[T4], t5y: Try[T5], t6y: Try[T6], t7y: Try[T7]) =>
      map7(t1y, t2y, t3y, t4y, t5y, t6y, t7y)(f)
  ...
  // TO BE IMPLEMENTED 
    (t4: T4) => (t3: T3) => (t2: T2) => (t1: T1) => f(t1)(t2)(t3)(t4)
